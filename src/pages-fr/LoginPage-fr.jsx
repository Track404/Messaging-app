          ...
          <div className="flex flex-col items-center md:w-[50vw]">
            ...
            <form className="mt-15" onSubmit={handleSubmit}>
              <div>
                ...
                <div className="mt-2 ">
                  <input
                    ...
                    id="email"
                    name="email"
                    className={`block w-80 h-10 rounded-md py-1.5 px-2 ring-1 ring-inset 
              ...
              <button
                ...
                type="button"
                className="group/button w-full mt-4 relative inline-flex gap-1 items-center justify-center overflow-hidden rounded-md bg-amber-400 backdrop-blur-lg px-0 py-2 text-base font-semibold text-white transition-all duration-300 ease-in-out hover:scale-110 hover:shadow-xl hover:shadow-gray-600/50 border border-white/20"
              >
                <User />
                <span className="text-lg">Compte invité</span>
                <div className="absolute inset-0 flex  h-full w-full justify-center [transform:skew(-13deg)_translateX(-100%)] group-hover/button:duration-1000 group-hover/button:[transform:skew(-13deg)_translateX(100%)]">
                  <div className="relative h-full w-10 bg-white/20"></div>
                </div>
              </button>
            ...
            <div className="flex gap-1 text-sm mt-2 font-light text-gray-500">
              <p>Vous n&lsquo;avez toujours pas de compte ? </p>
              <Link to="/inscription" className="text-amber-400">
                Inscription
              </Link>
            </div>
            {isSuccess && (
